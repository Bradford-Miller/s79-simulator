...
(scheme-79:scheme-79-version-reporter "Scheme Mech Regression Tests" 0 3 0
...
(defun assy-equalp (assy1 assy2)
  "given two lines of upla assembly code, check if they are equivalent"
...
#|| ;;somewhat problematic because tags (generated by the cond macro)
    ;;are gensyms, so need to have a better way to compare them
(test multi-arm-cond
